export class RandomBlob {
    ...
    private zones: Array<{xmin: number, xmax: number, ymin: number, ymax: number}> = []
    ...
    generateCoords() {
        this.zones.forEach(zone => {
          let x = this.getRandomBetween(zone.xmin, zone.xmax);
          let y = this.getRandomBetween(zone.ymin, zone.ymax);
